...
var hljs = function() {
    ...
    function u(e) { return m("(?:", e, ")*") }

    function b(e) { return m("(?:", e, ")?") }

    function m(...e) { return e.map((e => d(e))).join("") }
    ...
    var T = Object.freeze({
        ...
        SHEBANG: (e = {}) => {
            ...
            return e.binary && (e.begin = m(n, /.*\b/, e.binary, /\b.*/)), r({
                ...
                relevance: 0,
                "on:begin": (e, n) => { 0 !== e.index && n.ignoreMatch() }
            }, e)
        },
        BACKSLASH_ESCAPE: k,
        APOS_STRING_MODE: O,
    ...
    var Ue = Object.freeze({
        ...
        grmr_vbnet: e => {
            const n = e.regex,
                ...
                s = {
                    className: "literal",
                    variants: [{ begin: n.concat(/# */, n.either(a, t), / *#/) }, {
                        begin: n.concat(/# */, r, / *#/)
                    }, { begin: n.concat(/# */, i, / *#/) }, {
        ...
        grmr_yaml: e => {
            const n = "true false yes no null",
                ...
                }, { className: "number", begin: e.C_NUMBER_RE + "\\b", relevance: 0 }, s, o, a],
                c = [...l];
